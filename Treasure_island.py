...
if direction == "left":
    move = input("You've come to a lake. There is an island in the middle of the lake. Type \"wait\" to wait for a "
                 "boat. Type \"swim\" to swim across.\n").lower()
    if move == "wait":
        door = input("You arrive at the island unarmed. There is a house with 3 doors. One red, one yellow and one "
